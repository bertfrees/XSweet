...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
  ...
  <p:output port="Z_FINAL">
    <p:pipe port="result" step="final"/>
  </p:output>
  
  <p:output port="Input_HTML_tightened" primary="false">
  ...
  <p:serialization port="Z_FINAL"     indent="true" omit-xml-declaration="true"/>
  ...
  <p:serialization port="Input_HTML_tightened" indent="true" omit-xml-declaration="true"/>
  ...
  <p:xslt name="paragraphs-collapsed">
    <p:input port="source">
      <p:pipe port="_D_tightened" step="document-production"/>
    </p:input>
